/* ═══════════════════════════════════════════
   DR. CHANDRASHEKAR JATOTH — PORTFOLIO JS
   ═══════════════════════════════════════════ */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.hero-stats, .metrics-grid').forEach(el => counterObserver.observe(el));
  ...
  expTabs.forEach(tab => {
    tab.addEventListener('click', () => {
      ...
      if (tab.dataset.tab === 'academic') {
        acTl.classList.remove('hidden');
        adTl.classList.add('hidden');
      } else {
        acTl.classList.add('hidden');
        adTl.classList.remove('hidden');
        // Re-trigger reveal for admin items
        adTl.querySelectorAll('.reveal').forEach(el => {
  ...
  document.querySelectorAll('.research-card').forEach(card => {
    card.addEventListener('mousemove', e => {
      ...
      card.style.transform = `translateY(-6px) rotateX(${-cy * 6}deg) rotateY(${cx * 6}deg)`;
    });
